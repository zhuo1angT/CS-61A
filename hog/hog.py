...
def roll_dice(num_rolls, dice = six_sided):
    ...
    while i < num_rolls:
        ...
        if cur == 1:
            ...
            sum += cur
        i += 1
    return 1 if turn_over == True else sum
...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    arg = 3 ** (player_score + opponent_score)
    first_digit, last_digit = -1, arg % 10
    while arg >= 10:
        arg //= 10
    first_digit = arg
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        bonus = False
        if who == 0:
            if feral_hogs and abs(lst0 - strategy0(score0, score1)) == 2:
                bonus = True
            lst0 = take_turn(strategy0(score0, score1), score1, dice)
            score0 += lst0
            if bonus:
                score0 += 3
        else:
            if feral_hogs and abs(lst1 - strategy1(score1, score0)) == 2:
                bonus = True
            lst1 = take_turn(strategy1(score1, score0), score0, dice)
            score1 += lst1
            if bonus:
                score1 += 3
